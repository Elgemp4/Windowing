...
public class SimpleQueryStrategy implements QueryStrategy {
  ...
  public List<Segment> query(PST tree, QueryWindow queryWindow) {
    Objects.requireNonNull(
      tree,
      "PST arrived null in " + this.getClass().getSimpleName()
    );
    Objects.requireNonNull(
      queryWindow,
      "Query window arrived null in " + this.getClass().getSimpleName()
    );
