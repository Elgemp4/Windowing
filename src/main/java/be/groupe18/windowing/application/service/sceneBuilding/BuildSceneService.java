...
public class BuildSceneService implements ISceneBuilderService {
    ...
    public BuildSceneService(BuildStrategy buildStrategy, QueryStrategy queryStrategy,
        SimpleSplitStrategy<Segment> splitStrategy, IPSTRepository PSTRepository) {
