...
public class CompositeDouble {
  ...
  public static final CompositeDouble POSITIVE_INFINITY = new CompositeDouble(
    Double.POSITIVE_INFINITY,
    Double.POSITIVE_INFINITY
  );
  public static final CompositeDouble NEGATIVE_INFINITY = new CompositeDouble(
  ...
  public boolean isPositiveInfinite() {
    return (
      primary == Double.POSITIVE_INFINITY &&
      secondary == Double.POSITIVE_INFINITY
    );
  }
  ...
  public boolean isNegativeInfinite() {
    return (
      primary == Double.NEGATIVE_INFINITY &&
      secondary == Double.NEGATIVE_INFINITY
    );
  }
  ...
  public static boolean equalOrGreaterThan(
    CompositeDouble d1,
    CompositeDouble d2
  ) {
    if (d1.primary >= d2.primary) {
