...
public class Segment {
  ...
  public static final BiFunction<
    ...
    Segment,
    Boolean
  > greaterMinIntervalThan = (Segment s1, Segment s2) ->
    CompositeDouble.greaterThan(
      s1.getInterval().getIntervalMin(),
      s2.getInterval().getIntervalMin()
    );
  public static final BiFunction<Segment, Segment, Boolean> greaterOrigin = (
    Segment s1,
    Segment s2
  ) -> CompositeDouble.greaterThan(s1.getOrigin(), s2.getOrigin());
