...
public class UnboundedLeftVertQueryWindowTest extends AbstractWindowQueryTest {
    ...
    public UnboundedLeftVertQueryWindowTest() {
        super(
                ...
                QueryWindow.buildQueryWindows(Double.NEGATIVE_INFINITY, 50, 0, 50).getV1(),
