...
public class BoundedHorizQueryWindowTest extends AbstractWindowQueryTest {

    private static final List<Segment> INSIDE = Arrays.asList(
            new Segment(new Vector2D(10, 20), new Vector2D(40, 20)),
            new Segment(new Vector2D(5, 35), new Vector2D(45, 35))
    );
    ...
    public BoundedHorizQueryWindowTest() {
        super(
                ...
                QueryWindow.buildQueryWindows(0, 50, 0, 50).getV2(),
