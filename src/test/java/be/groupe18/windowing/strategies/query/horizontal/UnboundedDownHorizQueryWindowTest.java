...
public class UnboundedDownHorizQueryWindowTest extends AbstractWindowQueryTest {
    ...
    private static final List<Segment> THROUGH = Arrays.asList(
            ...
            new Segment(new Vector2D(-100, -10), new Vector2D(100, -10))
    );
    ...
    private static final List<Segment> OUTSIDE_GOOD_INT = Arrays.asList(
            new Segment(new Vector2D(10, 80), new Vector2D(40, 80)),
            new Segment(new Vector2D(10, 150), new Vector2D(40, 150))
    );
    ...
    private static final List<Segment> OUTSIDE = Arrays.asList(
            ...
            new Segment(new Vector2D(-50, 90), new Vector2D(-10, 90))
    );
