...
public class QuickSelectMedianTest {
  ...
  private final BiFunction<Double, Double, Boolean> greaterThan = (a, b) ->
    a > b;

  @BeforeEach
  public void initStrategies() {
    quickSelectMedianStrategy = new QuickSelectMedianStrategy<>(
  ...
  private void assertCorrectlyOrdered(
    List<Double> list,
    int medianIndex,
    int start,
    int end
  ...
  public void testOddSizedSmallList() {
    ...
    int medianIndex = quickSelectMedianStrategy.computeMedian(
      list,
      greaterThan,
      0,
      list.size()
  ...
  public void testLargeListWithClusters() {
    ArrayList<Double> list = mutableList(
      10.0,
      2.0,
      8.0,
      4.0,
  ...
  @Test
  @DisplayName(
    "Should run quickly and not cause any stack overflow with duplicates data"
  )
